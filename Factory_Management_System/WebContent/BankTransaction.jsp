<%@page import="com.itp.financial.services.Transactionimpl"%>
<%@page import="com.itp.financial.services.Transactioni"%>
<%@page import="com.itp.financial.model.modeltransaction"%>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="container">
              ...
              <div class="row">
    <div class="col">
      <h4 style="text-align: left;">Bank Transaction Table</h4>
    </div>
...
<br/>
   <div class="table-wrapper-scroll-y my-custom-scrollbar">
          <table id="dtBasicExample" class="table table-striped table-bordered table-sm">
                ...
                <tbody>
                 <%
                 Transactioni transactioni = new Transactionimpl();
						ArrayList<modeltransaction> TransactionList = transactioni.viewmodeltransaction();
												
					for(modeltransaction m : TransactionList){
					%>
						<tr>
						<!-- <th scope="row"></th> -->
							<td><%= m.getTransactionCode()%></td>
                        ...
                        <td><i class='fas fa-times' style="color:red;"></i></td> -->
							  <form method="post" action="Banktransactiontableop" >
							<td><button class="btn btn-success"name="update" value=<%= m.getTransactionCode() %>>
									<i class="fas fa-pen-square" style="font-size: 15px;"></i>
								</button></td>
							<td><button class="btn btn-danger"style="margin-left: 10px;" name="Remove"value=<%= m.getTransactionCode() %>>
...
<form method ="post" action="Transaction" id = "log" class="needs-validation" novalidate>

                    <div class="form-group">
                        <label for="validation1">Transaction Code</label>
                        <input type="text" value="<%out.println(transactioni.clientID_Generator(transactioni.getClientID())); %>" class="form-control" id="validation1" placeholder="Please enter a Transaction Code" name ="TransactionCode" required>
                       
                        <div class="invalid-feedback">
                            Please provide a Transaction Code.
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="validation2">Account No</label>
                        <input type="text" class="form-control" id="validation2" placeholder="Please enter a Account No" name ="AccountNo" required>
                        <div class="invalid-feedback">
                            Please provide a Account No.
                        </div>
                    </div>
