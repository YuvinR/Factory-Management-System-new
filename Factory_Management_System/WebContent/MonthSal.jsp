...
<head>
    ...
    <title>Monthly Payment Here</title>
</head>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="container">
              ...
              <div class="row">
    <div class="col">
      <h4 style="text-align: left;">Monthly Payment Table</h4>
    </div>
                  ...
                  <div class="modal-content" style=" background-color: #fefefe;">
                    ...
                    <div class="modal-body">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="validation1" placeholder="Employee ID" required>
                      ...
                      <div class="form-group">
                          <label for="validation2">Month</label>
                          <input type="month" class="form-control" id="validation2" placeholder="Month" required>
                          <div class="invalid-feedback">
                              Month
                          </div>
                      </div>
