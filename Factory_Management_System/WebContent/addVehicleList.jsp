	...
	<div class="wrapper">
		...
		<nav id="sidebar" class="navbar-expand-md mb-5"
			...
			<ul class="list-unstyled components mb-2">
				...
				<li class="active"><a href=addVehicleList.jsp>Distributing
						Vehicles</a></li>
			</ul>
			...
			<div class="modal-content" style="background-color: #fefefe;">
				...
				<div class="modal-body">
					...
					<form id="log" class="needs-validation" novalidate method="post"
						action="addDistVehicleServlet">

						<div class="form-group">

							<label for="validation1">Vehicle Number</label> <input
								type="text" class="form-control" id="validation1"
								placeholder="Please enter a Vehicle Number" name="vehiclenumber"
								required>
						...
						<div class="form-group">
							<label for="validation2">Vehicle Name</label> <input type="text"
								...
								placeholder="Please enter a Vehicle Name" name="vehiclename"
								required>
							<div class="invalid-feedback">Please provide a Vehicle
								Name.</div>
						</div>
						...
						<div class="form-group">
							<label for="validation2">Area</label> <input type="text"
								...
								placeholder="Please enter a Delivering Area" name="area"
								required>
						...
						<div class="form-group">
							<label for="validation3">Driver Id</label> <input type="text"
								...
								placeholder="Please enter a Driver Id" name="driverid" required>
						...
						<div class="form-group">
							<label for="validation4">Assistant Id</label> <input type="text"
								...
								placeholder="Please enter an Assistant" name="assistantid"
								required>
