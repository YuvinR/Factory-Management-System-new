	...
	<div class="wrapper">
		...
		<nav id="sidebar" class="navbar-expand-md mb-5"
			...
			<ul class="list-unstyled components mb-2">
				...
				<li class="active"><a href=addStockList.jsp>Stock InFlow</a></li>
		...
		<div id="content">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col">
						<h4 style="text-align: left;">Stock Inflow Table</h4>
					</div>
				...
				<div class="modal-body">
					...
					<form id="log" class="needs-validation" novalidate>
						...
						<div class="form-group">
							...
							<label for="validation1">Product Name</label> <input type="text"
								class="form-control" id="validation1"
								placeholder="Please enter a Product Name" required>
							<div class="invalid-feedback">Please provide a Product
								Name.</div>
						</div>

						<div class="form-group">
							<label for="validation2">Product Code</label> <input type="text"
								class="form-control" id="validation2"
								placeholder="Please enter a Product Code" required>
							<div class="invalid-feedback">Please provide a Product
								Code.</div>
						</div>

						<div class="form-group">
							<label for="validation3">Added Stock Count</label> <input
								type="number" class="form-control" id="validation3"
								placeholder="Please enter stock count added" required>
							<div class="invalid-feedback">Please provide Stock count.</div>
						</div>
