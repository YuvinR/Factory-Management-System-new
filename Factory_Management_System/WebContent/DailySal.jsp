...
<head>
    ...
    <title>Daily Payment Here</title>
</head>
    ...
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <div class="container">
              ...
              <div class="row">
    <div class="col">
      <h4 style="text-align: left;">Daily Payment Table</h4>
    </div>
          ...
          <table id="dtBasicExample" class="table table-striped table-bordered table-sm" width="100%">
                <thead>
                    <tr class="p-3 mb-2 bg-success text-white">
                        ...
                        <th scope="col">Number_of_Units</th>
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                  <div class="modal-content" style=" background-color: #fefefe;">
                    ...
                    <div class="modal-body">
                      ...
                      <form id = "log" class="needs-validation" novalidate method="post" action="DayilyUnitsList">
                      ...
                      <div class="form-group">
                        <label for="validation2">Units</label>
                        <input type="number" class="form-control" id="validation2" placeholder="Number of Units" name="NumUnits" required >
                        <div class="invalid-feedback">
                           Number_of_Units
                        </div>
                    </div>
