	...
	<div class="wrapper">
		...
		<nav id="sidebar" class="navbar-expand-md mb-5"
			...
			<ul class="list-unstyled components mb-2">
				...
				<li class="active"><a href=addShopList.jsp>Distribution
						Shops</a></li>
				<li><a href=addItemList.jsp>Distribution Items</a></li>
		...
		<div id="content">
				...
				<div class="row">
					...
					<div class="col col-lg-2">
						...
						<button class="btn btn-primary" type="button" data-toggle="modal"
							...
							<i class="fas fa-plus"></i> <span>Add Shop</span>
						</button>
			...
			<div class="table-wrapper-scroll-y my-custom-scrollbar">
				<table id="dtBasicExample"
					...
					<tbody>					
					<%
					IDistShop distshop1 = new IDistShopImpl();
					ArrayList<DistShop> distshopList = distshop1.viewDistShops();
					
					for(DistShop distshopi : distshopList){
					
					%>
					<tr>
					<td> <%= distshopi.getShopId() %> </td>
					<td> <%= distshopi.getShopName() %> </td>
					<td> <%= distshopi.getOwnerName() %> </td>
					<td> <%= distshopi.getContactNo() %> </td>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content" style="background-color: #fefefe;">
				...
				<div class="modal-body">
					...
					<form id="log" class="needs-validation" novalidate method="post" action="addDistShopServlet">

						<div class="form-group">

							<label for="validation1">Shop ID</label> <input type="text"
								class="form-control" id="validation1"
								placeholder="Please enter as Shop ID" name="shopid" required>
						...
						<div class="form-group">
							<label for="validation2">Shop Name</label> <input type="text"
								...
								placeholder="Please enter a Shop Name" name="shopname"required>
						...
						<div class="form-group">
							<label for="validation3">Owner Name</label> <input type="text"
								...
								placeholder="Please enter an Owner Name" name="ownername" required>
							<div class="invalid-feedback">Please provide a Owner Name.
							</div>
						</div>
						...
						<div class="form-group">
							<label for="validation4">Contact No</label> <input type="text"
								...
								placeholder="Please enter a Contact No" name="contactno" required>
